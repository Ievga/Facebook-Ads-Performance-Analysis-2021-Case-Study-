...
## 📊 Key Analysis Stages
### 1. Daily Ad Spend Trends ![Daily_Ad_Spend_Trends](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/Daily_Ad_Spend_Trends.png)
...
### 2. Spending Trends & Smoothing ![Daily_ROMI_&_Rolling_Average](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/Daily_ROMI_%26_Rolling_Average.png)
...
### 3. Campaign Budget Allocation ![Total_Ad_Spend_by_Campaign](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/Total_Ad_Spend_by_Campaign.png)
...
### 4. Campaign Efficiency (Mean ROMI) ![Average_ROMI_by_Campaign](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/Average_ROMI_by_Campaign.png)
...
### 5. Variance & Risk (Boxplot Analysis) ![ROMI_by_Campaign](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/ROMI_by_Campaign.png)
...
### 6. Correlation: Spend vs. Revenue ![ROMI_by_Campaign](https://github.com/Ievga/Facebook-Ads-Performance-Analysis-2021-Case-Study-/blob/main/images/Linear_Regression.png)
